<template>
  <div class="shop-dashboard-tab">
    ...
    <div class="dashboard-hero mb-4">
      <div class="d-flex align-items-center justify-content-between">
        <div>
          ...
          <p class="hero-subtitle mb-0">Welcome back! Here's your business overview.</p>
        </div>
    ...
    <div class="row g-3 mb-4">
      <div class="col-12 col-sm-6 col-lg-3" v-for="(metric, index) in metrics" :key="index">
        <div class="metric-card p-3" :style="{ animationDelay: `${index * 0.1}s` }">
            ...
            <div class="summary-content p-3 rounded">
              <div class="summary-item mb-3">
                <div class="d-flex align-items-start gap-2">
                  ...
                  <div>
                    <p class="mb-1">Sales increased by <strong>12%</strong> compared to last week</p>
                    <small class="text-muted">Cotton fabric showing highest demand</small>
                  </div>
                </div>
              </div>
              ...
              <svg viewBox="0 0 400 180" class="w-100" style="height: 180px;">
                <defs>
                  <linearGradient id="chartGradient" x1="0" x2="0" y1="0" y2="1">
                    ...
                    <stop offset="100%" stop-color="#764ba2" stop-opacity="0.02" />
                  </linearGradient>
                </defs>
                <!-- Chart line path -->
                <path 
        ...
        <div class="card modern-card">
          <div class="card-body">
            ...
            <div class="forecast-container p-3 rounded">
              <div class="row g-3">
                <div class="col-4" v-for="(forecast, index) in forecasts" :key="index">
                  <div class="forecast-item text-center" @click="viewForecastDetails(forecast)">
                    <div class="forecast-icon mb-2" :class="forecast.iconBg">
                      <i :class="forecast.icon" :style="{ color: forecast.color }"></i>
                    </div>
                    <small class="d-block fw-semibold mb-1">{{ forecast.name }}</small>
        ...
        <div class="card modern-card ai-insights-card">
          <div class="card-body">
            ...
            <div class="insights-container">
              <div class="insight-item mb-3" v-for="(insight, index) in aiInsights" :key="index">
                <div class="d-flex align-items-start gap-3">
                  ...
                  <button class="btn btn-sm btn-outline-gradient" @click="applyInsight(insight)">
                    Apply
                  </button>
                </div>
              </div>
        ...
        <div class="card modern-card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
              ...
              <button class="btn btn-outline-gradient btn-sm" @click="viewAllSuggestions">
                <i class="bi bi-grid-3x3-gap me-1"></i>
                View All
              </button>
            </div>
            <div class="reorder-carousel">
              <button class="carousel-nav-btn prev" @click="scrollCarousel('left')" v-show="showLeftArrow">
                <i class="bi bi-chevron-left"></i>
              </button>
              <div class="carousel-track" ref="carouselTrack" @scroll="updateArrows">
                <div class="reorder-card" v-for="(product, index) in reorderProducts" :key="index" @click="viewProduct(product)">
                  ...
                  <div class="product-details p-3">
                    ...
                    <button class="btn btn-gradient btn-sm w-100" @click.stop="addToCart(product)">
              ...
              <button class="carousel-nav-btn next" @click="scrollCarousel('right')" v-show="showRightArrow">
            ...
            >
              <div class="product-grid-image">
                ...
                <div class="product-overlay">
                  <button class="btn btn-light btn-sm" @click.stop="quickView(product)">
              ...
              <div class="product-grid-info p-3">
                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                  ...
                  <div class="stock-info text-end">
                    ...
                    <strong class="small" :class="product.stock > 10 ? 'text-success' : 'text-warning'">
                      {{ product.stock }} units
                    </strong>
                  </div>
                </div>
                <div class="product-grid-footer">
                  ...
                  <button class="btn btn-gradient btn-sm" @click.stop="addToCart(product)">
      ...
      <div v-if="showQuickView" class="modal-overlay" @click="closeQuickView">
        <div class="quick-view-modal" @click.stop>
          ...
          <div class="row g-4" v-if="selectedProduct">
            <div class="col-md-6">
              <img :src="selectedProduct.image" :alt="selectedProduct.name" class="w-100 rounded">
            </div>
            <div class="col-md-6">
              <h4 class="mb-3">{{ selectedProduct.name }}</h4>
              <div class="rating mb-3">
                <span v-for="i in 5" :key="i" class="text-warning">
                  <i :class="i <= selectedProduct.rating ? 'bi bi-star-fill' : 'bi bi-star'"></i>
                </span>
              ...
              <div class="mb-3">
                ...
                <small class="text-muted">Sold by: {{ selectedProduct.soldBy }}</small>
              </div>
              <button class="btn btn-gradient btn-lg w-100" @click="addToCart(selectedProduct)">
...
const aiInsights = ref([
  {
    ...
    description: 'Expect 20% increase in silk fabric demand during upcoming festive season. Consider increasing stock.'
  },
  {
    icon: 'bi bi-star-fill',
    title: 'Popular Product',
    description: 'Handwoven Cotton is trending. Restock recommended to meet demand surge.'
  }
])
...
const reorderProducts = ref([
  {
    ...
    image: 'https://images.unsplash.com/photo-1757382642968-0c8c9adbde0b?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=500',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1630312584379-ee017b579993?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=500',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1623658580841-217b1726a993?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=500',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1616057732603-0439d9ace394?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1470',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1634225288911-b7622186f517?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1470',
...
const availableProducts = ref([
  {
    ...
    image: 'https://images.unsplash.com/photo-1630961680768-998a170045fa?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=500',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1631089819675-ce4528460a32?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=500',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1613132962851-d054d7248a35?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=500',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1666112514180-193096c14938?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=500',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1639155330052-ef15046d5f09?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1470',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1630961680574-158007a1fb73?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=500',
...
const updateArrows = () => {
  ...
  if (track) {
    ...
    showRightArrow.value = track.scrollLeft < (track.scrollWidth - track.clientWidth - 10)
  }
}
